...
//Auto reset bluetooth every 30 min
const unsigned long BT_RESTART_TIME = 1000*60*30;

unsigned long lastBtRestartTime;
...
void loop(){
    ...
    if(btRestarted and millis()-lastBtRestartTime>BT_RESTART_TIME)
      btRestarted = false;
